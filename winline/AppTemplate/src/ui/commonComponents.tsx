...
import { Card, Layout, Menu, Space, Tooltip, TooltipProps, Typography } from "antd";
...
export const StyledTooltip: FC<TooltipProps> = ({ children, ...rest }) => (
  <Tooltip {...rest} placement="top" color={theme.colors.tooltipWhite} overlayInnerStyle={{ color: theme.colors.black, fontSize: 12 }}>
    {children}
  </Tooltip>
);
