...
export const FormLinksItem = ({ isUpdatedLink, changeLinkValue, linkType, linkValue, isDisabledButtonData }: IProps) => {
  ...
  const [currentLinkType, setCurrentLinkType] = useState<string>(linkType || "DeepLink");
  ...
  return (
    <Form.Item key={`${disabledLinkSelect.screen}${disabledLinkSelect.hyperlink}`} label={t("common.link")} required={false}>
      <Radio
        ...
        onClick={() => {
          changeStateLinks("DeepLink");
          setCurrentLinkType("DeepLink");
        }}
      >
      ...
      <Radio
        ...
        disabled={disabledRadio}
        onClick={() => {
          changeStateLinks("HyperLink");
          setCurrentLinkType("HyperLink");
        }}
      >
