...
export const getWinlineData = async (date: string): Promise<ISelect[]> => {
  return get(`${process.env.REACT_APP_MOBILE}/admin/Matching/GetWinlineCoefficient?matchDate=${date}`);
};
