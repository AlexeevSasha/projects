...
const PlayersTable = lazy(async () => import("./players/PlayersTable").then((module) => ({ default: module.PlayersTable })));
...
const routes: IRoute[] = [
  ...
  },
  {
    ...
    access: accessNames.player,
    element: (access: boolean) => <PlayersTable access={access} />
  }
];
