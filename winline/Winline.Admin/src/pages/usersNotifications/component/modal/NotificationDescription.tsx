...
export const NotificationDescription = ({ notification, onClose, projects, cities }: IProps) => {
  ...
  return (
    ...
    >
      <Descriptions column={1}>
        ...
        <Descriptions.Item label={t("users.notifications.type")}>{notification?.type}</Descriptions.Item>
        ...
        <Descriptions.Item label={t("common.project")}>
          {projects?.find((option) => option.value === notification?.projectId)?.label}
        </Descriptions.Item>
      </Descriptions>
      <Divider />
      <Descriptions column={1}>
      ...
      <Descriptions column={1} title={t("users.notifications.auditoryFilter")}>
        ...
        {notification?.type === "Push" && (
          <>
            ...
            <Descriptions.Item label={t("users.notifications.over18")}>{t("common.yes")}</Descriptions.Item>
            <Descriptions.Item label={t("users.notifications.policyAgreement")}>{t("common.yes")}</Descriptions.Item>
          </>
        )}
      </Descriptions>
    </Drawer>
