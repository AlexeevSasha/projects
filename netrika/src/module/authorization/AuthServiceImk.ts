...
export class AuthServiceImk {
  public userManager: UserManager;

  constructor() {
    const settings = {
      authority: AppSettings.get("authorityImk"),
      ...
      post_logout_redirect_uri: `${window.location.origin}${AppSettings.get("REACT_APP_ROOT_FOLDER")}/proposal`,
