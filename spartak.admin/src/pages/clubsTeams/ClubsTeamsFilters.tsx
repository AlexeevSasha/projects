...
import { TeamsFilters } from "common/interfaces/teams";
...
export const ClubsTeamsFilters = React.memo(({ onChange, resetFilters }: Props) => {
  const { t } = useTranslation();
  const [form] = Form.useForm<TeamsFilters>();
