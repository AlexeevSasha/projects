...
import { GraduateSectionsFiltersEntity } from "common/interfaces/graduateSections";
...
export const GraduateSectionsFilters = memo(({ onChange, resetFilters }: Props) => {
  const { t } = useTranslation();
  const [form] = Form.useForm<GraduateSectionsFiltersEntity>();
