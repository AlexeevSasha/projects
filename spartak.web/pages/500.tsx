...
export default function LoadError() {
  const { locale = "ru", reload } = useRouter();
    ...
    <Layout metaTags={metaTags}>
      <Container>
        <div>
          ...
          <Title>{lang[locale].loadError.title}</Title>

          <Text>{lang[locale].loadError.text}</Text>

          <Button type="red" onClick={() => reload()}>
            {lang[locale].loadError.button}
          </Button>
        </div>

        <ImageBlock>
          <BgImage><NextImage src="/images/errorPage/bg_v1.0.0.png" /></BgImage>
          <NextImage src="/images/errorPage/502_img_v1.0.0.png" />
        </ImageBlock>

        <Button type="red" onClick={() => reload()} mobile>
          {lang[locale].loadError.button}
        </Button>
      </Container>
    </Layout>
