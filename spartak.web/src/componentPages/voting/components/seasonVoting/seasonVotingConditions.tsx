...
export const SeasonVotingConditions = (props: IProps) => {
    ...
    <Container id="condition">
      ...
      <RulesContainer>
        <Rule isVote={props.isVote}>
          ...
          <Text dangerouslySetInnerHTML={{ __html: langVoting[locale].season.conditions[0] }} />
        </Rule>
        <Rule>
          <Number>2</Number>
          ...
          <Text dangerouslySetInnerHTML={{ __html: langVoting[locale].season.conditions[1] }} />
        </Rule>
        <Rule>
          <Number>3</Number>
          <Link href={"https://winline.ru"} passHref>
          ...
          <Text dangerouslySetInnerHTML={{ __html: langVoting[locale].season.conditions[2] }} />
        </Rule>
      </RulesContainer>
    </Container>
  );
