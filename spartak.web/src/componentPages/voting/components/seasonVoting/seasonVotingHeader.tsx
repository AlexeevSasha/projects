...
export const SeasonVotingHeader = ({ voting }: Props) => {
  ...
  return (
    <Container>
      <ContainerImage>
        <NextImage
          src={`/images/mvp/seasonTopBanner${bannerSize}_v1.0.2.png`}
          priority
          alt="баннер winline игрок сезона"
        />
      </ContainerImage>
      <Gradient />

      <TitleContainer>
        <Title>{langVoting[locale].seasonModalHeader}</Title>
