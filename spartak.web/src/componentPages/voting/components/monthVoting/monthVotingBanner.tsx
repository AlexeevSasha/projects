...
export const MonthVotingBanner = () => {
  ...
  return (
    <Container>
      <VotingSectionTitle>{langVoting[locale].month.presentTheAward.title}</VotingSectionTitle>
      <List>
        {langVoting[locale].month.presentTheAward.list.map((elem, i) => (
          <li key={i}>
